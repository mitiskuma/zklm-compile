...
INT8 x INT8 accumulated over 768 terms = 24 bits max -> fits with 7 bits headroom.
...
from zk_ml_audit.constants import M31
...
# Public aliases expected by consumers (e.g. "from zk_ml_audit.m31 import m31_add")
m31_add = add
m31_sub = sub
m31_mul = mul
m31_neg = neg
